...
- Name: books-wishlist.spec.ts >> Reading Wishlist >> displays cover image on wishlist for imported book with cover
- Location: tests/e2e/books-wishlist.spec.ts:121:7
...
Locator: getByAltText('Cover of Cover Book')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByAltText('Cover of Cover Book')
...
- banner:
  - navigation:
    ...
    - link "Search":
      - /url: /search
- main:
  - heading "Reading Wishlist" [level=1]
  - paragraph:
    - link "Search & Import Books from Google Books":
      - /url: /search
  - heading "Add a Book" [level=2]
  - text: Title
  - textbox "Title"
  - text: Author
  - textbox "Author"
  - text: Cover Image (optional)
  - button "Cover Image (optional)"
  - button "Add Book"
  - paragraph: Your wishlist is empty. Add a book to get started!
- alert
```
