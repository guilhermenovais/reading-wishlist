...
- Name: books-wishlist.spec.ts >> Reading Wishlist >> views book details
- Location: tests/e2e/books-wishlist.spec.ts:54:7
...
Call log:
  - waiting for getByRole('link', { name: /Detail Book/ })
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e7]:
    ...
    - generic [ref=e11]:
      ...
      - alert [ref=e13]: "Invalid `prisma.book.create()` invocation: { data: { title: \"Detail Book\", author: \"Detail Author\", status: \"WISHLIST\", isbn: null, publicationYear: null, coverImageUrl: null, ~~~~~~~~~~~~~ ? readingStartDate?: DateTime | Null, ? createdAt?: DateTime } } Unknown argument `coverImageUrl`. Available options are marked with ?."
      - generic [ref=e14]:
        - generic [ref=e15]: Title
        - textbox "Title" [ref=e16]: Detail Book
      - generic [ref=e17]:
        - generic [ref=e18]: Author
        - textbox "Author" [ref=e19]: Detail Author
      - generic [ref=e20]:
