...
- Name: books-wishlist.spec.ts >> Reading Wishlist >> removes a book with confirmation
- Location: tests/e2e/books-wishlist.spec.ts:68:7
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Remove Me' }).getByRole('button', { name: 'Remove' })
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e7]:
    ...
    - generic [ref=e11]:
      ...
      - alert [ref=e13]: "Invalid `prisma.book.create()` invocation: { data: { title: \"Remove Me\", author: \"Test Author\", status: \"WISHLIST\", isbn: null, publicationYear: null, coverImageUrl: null, ~~~~~~~~~~~~~ ? readingStartDate?: DateTime | Null, ? createdAt?: DateTime } } Unknown argument `coverImageUrl`. Available options are marked with ?."
      - generic [ref=e14]:
        - generic [ref=e15]: Title
        - textbox "Title" [ref=e16]: Remove Me
      - generic [ref=e17]:
        - generic [ref=e18]: Author
        - textbox "Author" [ref=e19]: Test Author
      - generic [ref=e20]:
